...
// import { format, addMonths, subMonths, parse, isValid, getDaysInMonth } from "date-fns";
...
//     // Approximate section based on click position
//     // Day section (approximately first 20% of input)
//     if (clickPosition < inputWidth * 0.2) {
//       setActiveSection(1);
//       selectSection(1);
//     } 
//     // Month section (approximately between 20-40% of input)
//     else if (clickPosition < inputWidth * 0.4) {
//       setActiveSection(2);
//       selectSection(2);
//     } 
//     // Year section (approximately remaining part of input)
//     else {
//       setActiveSection(3);
//       selectSection(3);
//     }
...
//       start = 0;
//       end = 2;
//     } else if (section === 2) { // Month
//       start = 3;
//       end = 5;
//     } else if (section === 3) { // Year
//       start = 6;
//       end = 10;
//     }
...
//                       className={cn(
//                         "pr-10", 
//                         isInputActive || (inputValue !== "DD/MM/YYYY") ? "" : "text-muted-foreground"
//                       )}
//                       value={inputValue}
